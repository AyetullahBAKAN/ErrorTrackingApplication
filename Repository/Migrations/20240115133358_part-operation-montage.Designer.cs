...
namespace Repository.Migrations
{
    ...
    [Migration("20240115133358_part-operation-montage")]
    partial class partoperationmontage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.MontageLetter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("873f5156-1b3d-4201-b83c-dd5e9a172f71"),
                            CreateDate = new DateTime(2024, 1, 15, 16, 33, 57, 106, DateTimeKind.Local).AddTicks(3913),
                            IsActive = true,
                            IsDeleted = false,
                            MontageNumber = "22AFN"
                        });
            ...
            modelBuilder.Entity("Core.Models.Operation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eb1d520d-da4e-4714-9a42-43cd0919d41c"),
                            CreateDate = new DateTime(2024, 1, 15, 16, 33, 57, 106, DateTimeKind.Local).AddTicks(4172),
                            IsActive = true,
                            IsDeleted = false,
                            OperationNo = "OP10_ACINIM"
                        });
                });
            ...
            modelBuilder.Entity("Core.Models.Part", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("403cf4a8-9e9f-4217-8b4f-a49c04ca13eb"),
                            CreateDate = new DateTime(2024, 1, 15, 16, 33, 57, 106, DateTimeKind.Local).AddTicks(4298),
                            IsActive = true,
                            IsDeleted = false,
                            PartNo = "0203900021_22_"
                        });
                });
            ...
            modelBuilder.Entity("Core.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b7954b9b-913b-46f9-b4cb-250ce9453343"),
                            CreateDate = new DateTime(2024, 1, 15, 16, 33, 57, 106, DateTimeKind.Local).AddTicks(4435),
                            CustomerId = new Guid("c77f95f6-d8cc-406b-8598-d32dc75969e8"),
                            IsActive = true,
                            IsDeleted = false,
