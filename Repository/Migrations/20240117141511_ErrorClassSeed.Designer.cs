...
namespace Repository.Migrations
{
    ...
    [Migration("20240117141511_ErrorClassSeed")]
    partial class ErrorClassSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.ErrorClass", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5824119e-9ae7-4786-ba03-8b8786cf88fe"),
                            CreateDate = new DateTime(2024, 1, 17, 17, 15, 9, 787, DateTimeKind.Local).AddTicks(9795),
                            ErrorMainTitleId = new Guid("0040d100-e949-444d-aa63-3edd5accf96b"),
                            ErrorSubGroupId = new Guid("05de5f7b-8e09-4220-ada6-afecd02f5956"),
                            IsActive = true,
                            IsDeleted = false,
                            ShortDetail = "İşlem Sırasında Yapılan Hatadan Dolayı Arıza Oluşmuştur"
                        });
                });
