...
namespace Repository.Migrations
{
    ...
    [Migration("20240117135535_PatternSeed")]
    partial class PatternSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.Pattern", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b0e2c25d-a4af-4e0d-bf60-4f5aaad9c2e9"),
                            CreateDate = new DateTime(2024, 1, 17, 16, 55, 34, 179, DateTimeKind.Local).AddTicks(8191),
                            CustomerId = new Guid("c77f95f6-d8cc-406b-8598-d32dc75969e8"),
                            IsActive = true,
                            IsDeleted = false,
                            MontageLetterId = new Guid("873f5156-1b3d-4201-b83c-dd5e9a172f71"),
                            OperationId = new Guid("eb1d520d-da4e-4714-9a42-43cd0919d41c"),
                            PartId = new Guid("403cf4a8-9e9f-4217-8b4f-a49c04ca13eb"),
                            ProjectId = new Guid("b7954b9b-913b-46f9-b4cb-250ce9453343")
                        });
                });
