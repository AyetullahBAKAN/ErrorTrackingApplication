...
namespace Repository.Migrations
{
    ...
    [Migration("20240121092722_ErrorCardSeed")]
    partial class ErrorCardSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.ErrorCard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("96fba1db-522e-46b4-8066-4ddddcf8b0bd"),
                            CostId = new Guid("0c3aba21-2e4a-4c5a-8bcd-2baef73a8306"),
                            CreateDate = new DateTime(2024, 1, 21, 12, 27, 17, 384, DateTimeKind.Local).AddTicks(6146),
                            DateFinish = new DateTime(2024, 1, 21, 12, 27, 17, 384, DateTimeKind.Local).AddTicks(6131),
                            DateStart = new DateTime(2024, 1, 21, 12, 27, 17, 384, DateTimeKind.Local).AddTicks(6107),
                            ErrorClassId = new Guid("5824119e-9ae7-4786-ba03-8b8786cf88fe"),
                            ErrorDefineId = new Guid("7a21f2d5-d9ac-47bf-8653-36474ab1cbb6"),
                            ErrorDetectionLocationId = new Guid("da34c50e-0039-4bb9-a89b-24015e457182"),
                            FormNumber = "1A",
                            IsActive = true,
                            IsDeleted = false,
                            PageNumber = 1,
                            PatternId = new Guid("b0e2c25d-a4af-4e0d-bf60-4f5aaad9c2e9"),
                            RevNumber = 1,
                            RootAnalysisId = new Guid("52001537-8daf-450e-b9c9-fe5793ba3ed2"),
                            SolutionAndStandardizitionId = new Guid("d6b7107a-c126-44f3-a265-6c3395c1a1b0"),
                            StateId = new Guid("5e45933b-210d-4fd8-aea3-355bb9b905bc"),
                            UnitId = new Guid("cad2b84f-b68e-4c38-94be-bedd9fc9d254"),
                            UserId = new Guid("e6ba61db-6206-4aa9-ea0d-08dc15a26e0a")
                        });
                });
